...
const EditPost: FunctionComponent<EditPostProps> = ({userInfo}) => {
    ...
    let [currentPost , setCurrentPost] = useState<Post>({title: "",subtitle:"",description:"",phone:"" ,email: "", website: "",imageUrl:"", imageAlt:"",country:"",state:"",city:"",street:"",houseNum:0,zip:"" });
    ...
    let formik = useFormik({
        initialValues: {
            title: currentPost?.title,subtitle:currentPost?.subtitle,description:currentPost?.description,phone:currentPost?.phone ,email: currentPost?.email, website: currentPost?.website,imageUrl:currentPost?.imageUrl, imageAlt:currentPost?.imageAlt,country:currentPost?.country,state:currentPost?.state,city:currentPost?.city,street:currentPost?.street,houseNum:currentPost?.houseNum,zip:currentPost?.zip },
            ...
            onSubmit(values) {
                updatePost(values,Number(postId))
                .then((res)=> {
