...
const AddPost: FunctionComponent<AddPostProps> = ({userInfo}) => {
    ...
    let formik = useFormik({
        initialValues: {
            title: "",subtitle:"",description:"",phone:"" ,email: "", website: "",image:{imageURL:"",imageAlt:""},address: {state: "",country:"",city: "",street: "",houseNum: 0, zip: ""
            }},
            ...
            onSubmit(values) {
                ...
                let bizNumber:number = Math.floor(Math.random() * (99999 - 10000 + 1) ) + 10000;
                addPost({...values, userId: postUserId , biznumber:bizNumber})
                .then((res)=> {
